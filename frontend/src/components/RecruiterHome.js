                    ...
                    <div className="collapse navbar-collapse">
                        <ul className="navbar-nav mr-auto">
                            <li className="navbar-item">
                                <Link to="/Recruiteraddjob" className="nav-link">Add Job</Link>
                            </li>    
                            <li className="navbar-item">
                                <Link to="/Recruiterjoblist" className="nav-link">View Jobs</Link>
                            </li>
                            <li className="navbar-item">
                                <Link to="/Recruiteraccept" className="nav-link">Accepted Jobs</Link>
                            </li>                       
                        </ul>
                    </div>
                </nav>                    
            <h1> Hello {this.state.data.name} </h1>    
            <a href="/Recruiteredit" style={mystyle} >Edit Profile</a>
            </div>
        );
    }
}